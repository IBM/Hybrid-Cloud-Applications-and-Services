...
To contribute code or documentation, please submit a pull request to the [GitHub repository](https://github.com/IBM/Hybrid-Cloud-Applications-and-Services).

A good way to familiarize yourself with the codebase and contribution process is to look for and tackle low-hanging fruit in the [issue tracker](https://github.com/IBM/Hybrid-Cloud-Applications-and-Services/issues). Before embarking on a more ambitious contribution, please quickly [get in touch](#communication) with us.
...
If you would like to implement a new feature, please [raise an issue](https://github.com/IBM/Hybrid-Cloud-Applications-and-Services/issues) before sending a pull request so the feature can be discussed.
...
If you would like to fix a bug, please [raise an issue](https://github.com/IBM/Hybrid-Cloud-Applications-and-Services/issues) before sending a pull request so it can be discussed.
